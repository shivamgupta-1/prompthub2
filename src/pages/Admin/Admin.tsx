...
export default function Admin() {
  ...
  const [selectedView, setSelectedView] = useState<'dashboard' | 'categories'>('dashboard');
                  ...
                  <ul className="space-y-2">
                    <li>
                      <button
                        ...
                        className={`flex items-center gap-3 w-full px-3 py-4 rounded-lg text-md font-medium ${selectedView === 'dashboard' ? 'text-violet-600 bg-violet-50' : 'text-slate-700 hover:bg-slate-50'}`}
                      >
                    ...
                    <li>
                      <button
                        ...
                        className={`flex items-center gap-3 w-full px-3 py-4 rounded-lg text-md font-medium ${selectedView === 'categories' ? 'text-violet-600 bg-violet-50' : 'text-slate-700 hover:bg-slate-50'}`}
                      >
                        Categories
                      </button>
                    </li>
