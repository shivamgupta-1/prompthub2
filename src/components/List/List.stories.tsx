...
export const Default: Story = {
  args: {
    ...
    children: (
      <>
        <li style={{ padding: 'var(--space-3)', fontSize: 'var(--font-size-md)', color: 'var(--text-primary)', cursor: 'pointer', borderRadius: 'var(--radius-md)', transition: 'all var(--transition-normal)' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = 'var(--bg-hover)')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'transparent')}>
          Item 1
        </li>
        <li style={{ padding: 'var(--space-3)', fontSize: 'var(--font-size-md)', color: 'var(--text-primary)', cursor: 'pointer', borderRadius: 'var(--radius-md)', transition: 'all var(--transition-normal)' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = 'var(--bg-hover)')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'transparent')}>
          Item 2
...
export const Disabled: Story = {
  args: {
    ...
    children: (
      <>
        <li style={{ padding: 'var(--space-3)', fontSize: 'var(--font-size-md)', color: 'var(--text-secondary)' }}>
          Item 1
        </li>
        <li style={{ padding: 'var(--space-3)', fontSize: 'var(--font-size-md)', color: 'var(--text-secondary)' }}>
          Item 2
